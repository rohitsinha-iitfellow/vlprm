...
def load_dataset_mathv(dataset_name='MathVision_MINI'):
    """Load the MathVision dataset."""
    dataset_url = 'https://opencompass.openxlab.space/utils/VLMEval/MathVision_MINI.tsv'
    dataset_md5 = '060fe4fa5d868987ce179307bd5f8a33'
    ...
    # Download if not exists or MD5 doesn't match
    if not os.path.exists(data_path) or md5(data_path) != dataset_md5:
        print(f"Downloading {dataset_name} dataset...")
